...
<p class="card-text">{{ post.description }}</p>
                    ...
                    <p class="post-meta">
                      ...
                      <a href="{{ year | prepend: '/articles/' | prepend: site.baseurl}}">
      ...
      <p class="post-tags">
        <a href="{{ year | prepend: '/articles/' | prepend: site.baseurl}}">
          ...
          &nbsp; &middot; &nbsp;
            ...
            <a href="{{ tag | slugify | prepend: '/articles/tag/' | prepend: site.baseurl}}">
          ...
          &nbsp; &middot; &nbsp;
            ...
            <a href="{{ category | slugify | prepend: '/articles/category/' | prepend: site.baseurl}}">
