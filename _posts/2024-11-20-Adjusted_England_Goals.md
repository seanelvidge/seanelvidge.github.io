...
<table id="dataTable">
  <thead>
    <tr>
<th onclick="sortTable('dataTable', 0)">Name</th><th onclick="sortTable('dataTable', 1)">Caps</th><th onclick="sortTable('dataTable', 2)">Total Goals</th><th onclick="sortTable('dataTable', 3)">Goals per cap</th><th onclick="sortTable('dataTable', 4)">Weighted Goals</th><th onclick="sortTable('dataTable', 5)">Adjusted Total</th>
    </tr>
  </thead>
  <tbody>
