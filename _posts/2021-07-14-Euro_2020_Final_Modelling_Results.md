...
(As a reminder: the model description is [here](https://seanelvidge.com/articles/2021/Euro_2020_Predictions/){:target="\_blank"} and the other models we compare against are [here](https://seanelvidge.com/articles/2021/Euro_2020_Round_1_Results_and_Validation/).)
