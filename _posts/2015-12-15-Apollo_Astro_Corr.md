...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/apollo_az.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
For those interested, here's the [code used to create the plot](https://seanelvidge.com/assets/code/apollo_astronaut_az.py), which can serve as a starting point for experimenting with `plt.xkcd()`.
