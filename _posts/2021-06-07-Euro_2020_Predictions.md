...
For the 2018 World Cup I created a prediction model for the tournament (you can read the [details here](https://seanelvidge.com/articles/2018/World_Cup_2018_Predictions/){:target="\_blank"}. Overall the model did well and I was pretty happy with it.
