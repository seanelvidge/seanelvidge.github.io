...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        <figure>
            {% include figure.liquid loading="eager" path="assets/img/mathsonamug/mathsonamug_9.jpeg" class="img-fluid rounded z-depth-1" zoomable=true %}
        </figure>
    </div>
</div>
...
<div style="display: flex; justify-content: space-between; align-items: center;">
    <a href="https://seanelvidge.com/articles/2019/Maths_on_a_Mug_8/" style="text-decoration: none;">Previous Maths on a Mug</a>
    <a href="https://seanelvidge.com/articles/2020/Maths_on_a_Mug_10/" style="text-decoration: none;">Next Maths on a Mug</a>
</div>
